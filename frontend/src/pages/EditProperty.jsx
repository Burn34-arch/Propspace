...
import { Edit, PlusCircle, X, ImagePlus } from 'lucide-react';
import { fetchPropertyById, updateProperty } from '../api/property.api';
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-navy-900 flex items-center gap-2">
          <Edit className="w-7 h-7 text-gold-500" /> Edit Property
        </h1>
